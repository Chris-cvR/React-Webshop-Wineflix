   ...
   with user information as attributes. maybe a problem is that email is not a parameteer but the indicidual basket? Not sure how to change to fit our setup of the json file
